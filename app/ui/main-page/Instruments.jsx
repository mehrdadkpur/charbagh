...
const Instruments = async () => {
    ...
    return (
        <section>
            <div className="w-full bg-[#F0EEE6] dark:bg-[#25403c] flex justify-between flex-col">
                <div className="container py-25">
                    <div className="content w-full flex justify-between items-center flex-col lg:flex-row gap-y-10">
                        <div className="right lg:w-1/3 md:h-full flex justify-between items-center flex-col gap-y-4 lg:gap-y-6 lg:pb-6">
                            <div className="text-center text-[#018A75] mt-4 text-sm font-DanaMedium">درس های موسیقی که ما تدریس می کنیم</div>
                            ...
                            <Link href='/instruments' className="w-30 lg:w-36 p-3 flex justify-center items-center font-DanaMedium text-xl text-white bg-[#018A75] rounded-full hover:bg-mango hover:text-[#152422] transition-all duration-300">بزن بریم</Link>
                        </div>
