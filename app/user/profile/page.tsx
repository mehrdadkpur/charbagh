...
if (!user) return <div>Loading...</div>
    ...
    return ( 
        <div className="w-full flex justify-center pr-[340px] pl-10 mt-3 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-50 min-h-screen">
            <div className="w-full p-5 flex justify-center rounded-xl">
                <div className="w-full flex flex-col justify-center items-center gap-y-5 ">
                    <span className="w-full flex justify-center items-center font-MorabbaMedium text-3xl mb-4"> {user?.role === "teacher"? " پنل کاربری مدرس": " پنل کاربری هنرآموز"} </span>
