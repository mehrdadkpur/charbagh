...
const Photos = () => {
  ...
  const handleSearch=(e)=>{
    ...
    const allPhotos = photos.filter((photo)=>{
        return photo.title.toLowerCase().includes(e.target.value.toLowerCase());
    })
                                ...
                                <tr key={photo._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <div className="flex items-center">
                                        <div className="w-10 h-10 flex-shrink-0">
                                            <Image width={40} height={40} className="rounded-full object-cover" src={photo.url || null} alt={photo.title}/>
                                        </div>
                                        <div className="mr-3">
