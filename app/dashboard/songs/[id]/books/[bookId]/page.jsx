...
const Songs = () => {
    ...
    useEffect(() => {
        const fetchSongData = async () => {
            ...
            try {
                ...
                const currentBook = data.books.find(book => book._id === bookId)
    ...
    const handleDeleteSong = async () => {
        try {
            ...
            if (res.ok) {
                ...
                toast.success('با موفقیت حدف شد')
    ...
    const handleSearch =(e)=>{
        ...
        const allSongs = instrument.currentBook.songs.filter((song)=>{
            const songNameMatch = song.song_title.toLowerCase().includes(e.target.value.toLowerCase());
            const songArtistNameMatch = song.song_artist.toLowerCase().includes(e.target.value.toLowerCase());
