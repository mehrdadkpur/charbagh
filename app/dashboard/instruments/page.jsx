...
const Instruments = () => {
  ...
  const handleOpenModal=(instrumentId)=>{
    setIsModalOpen(true);
                    ...
                    <div className="relative w-full overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <div tabIndex="-1" aria-hidden="true" className={`${!isModalOpen?"hidden":"w-full flex justify-center items-center fixed z-50 bg-black/50 font-DanaDemiBold md:inset-0"}`}>
                            <div className="relative p-4 w-full max-w-md h-screen md:h-auto">
                                ...
                                <p className="mb-4 text-gray-500 dark:text-gray-300">مطمئن هستی می خوای این ساز پاک بشه؟</p>
                                <div className=" flex justify-center items-center gap-x-4">
                                    ...
                                    <button onClick={handleDeleteInstrument} type="submit" className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                        آره بابا پاکش کن
                                    </button>
                                </div>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr key={instrument._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <div className="w-10 h-10 flex-shrink-0"> 
                                        <Image width={40} height={40} className="rounded-full object-cover" src={instrument.instrument_img} alt={instrument.instrument_name} /> 
                                    </div>
                                        <div className="mr-3">
