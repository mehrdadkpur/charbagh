...
const EditTeacherForm = () => {
    ...
    const [imagePreview, setImagePreview] = useState(fields.mainImg);
      ...
      <form onSubmit={handleSubmit} className="w-full flex justify-center items-center flex-col gap-y-5 font-Dana text-nowrap" >
        <div className="w-full grid grid-cols-2 gap-y-5 gap-x-10">
          ...
          <div className="w-full flex justify-center items-center gap-x-2 ">
                  ...
                  <div className="w-2/3">
                    <ShamsiDatePicker onRegistryDateChange={handleRegistryDateChange} initialDate={initialDates.registryDate} />
                  </div>
          </div>
          <div className="w-full flex justify-center items-center gap-x-2">
